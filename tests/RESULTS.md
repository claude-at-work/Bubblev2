...
_Run: 2026-04-27T12:35:25 — 25 passed, 0 failed, 0 skipped._
...
```
vault_db: /tmp/bubble-test-joqnugly/vault.db
...
`10_breakers/test_bundle_round_trip.py` — 436 ms

```
bundled: 2 packages, 13 files, 1984 bytes
...
`10_breakers/test_canonical_name_validated.py` — 58 ms
...
`10_breakers/test_drift_refuses_and_records.py` — 84 ms
...
`10_breakers/test_empty_script_fetches_nothing.py` — 21 ms
...
`10_breakers/test_fetcher_refuses_off_host_url.py` — 32 ms
...
```
flatmod_old.__file__: /tmp/bubble-test-_lhi34nq/vault/flatmod/1.0.0/py3-none-any/flatmod.py
flatmod_new.__file__: /tmp/bubble-test-_lhi34nq/vault/flatmod/2.0.0/py3-none-any/flatmod.py
...
`10_breakers/test_https_index_required.py` — 38 ms
...
`10_breakers/test_late_alias_does_not_corrupt_earlier.py` — 44 ms
...
module id stable:  0x7c3f305350 → 0x7c3f305350
class id stable:   0x18be5150 → 0x18be5150
STATE dicts distinct: old@0x7c3f2f3880 vs new@0x7c3f31ff80
...
`10_breakers/test_modules_and_deps_indexed.py` — 44 ms
...
`10_breakers/test_sdist_refused_by_default.py` — 547 ms
...
`10_breakers/test_shell_create_from_manifest.py` — 82 ms
...
`10_breakers/test_top_level_contention_logged.py` — 38 ms
...
`10_breakers/test_top_level_index_bridges_import_to_dist.py` — 59 ms

```
distribution name: Carbohydrate-9000
top-level import:  sugar
top_level row:     ('Carbohydrate-9000', '3.0.0', 'sugar')
resolved module:   /tmp/bubble-test-9gv70av2/vault/Carbohydrate-9000/3.0.0/py3-none-any/sugar/__init__.py
...
`10_breakers/test_top_level_verify_mode.py` — 32 ms
...
`10_breakers/test_two_versions_one_process.py` — 69 ms

```
widget_old.Widget: id=0x361df250
widget_new.Widget: id=0x361dc760
...
```
  bubble-test-yb59gwx9 mode=0o700
  vault              mode=0o700
  .staging           mode=0o700
  shells             mode=0o700
  wheels             mode=0o700
...
`30_loop/test_dlmopen_routing_through_proxy.py` — 100 ms
...
`30_loop/test_dlmopen_substrate_handler.py` — 71 ms
...
staged islet==3.1.4 at /tmp/bubble-test-zf5kouks/vault/islet/3.1.4/py3-none-any
...
```
probed_at: 2026-04-27T12:35:25.561410
...
`30_loop/test_substrate_routing_learns.py` — 68 ms
