...
_Run: 2026-04-27T17:36:27 — 29 passed, 0 failed, 0 skipped._
...
```
vault_db: /tmp/bubble-test-hbo4h4rs/vault.db
...
`10_breakers/test_bundle_round_trip.py` — 131 ms

```
bundled: 2 packages, 13 files, 2048 bytes
...
`10_breakers/test_canonical_name_validated.py` — 35 ms
...
`10_breakers/test_drift_refuses_and_records.py` — 47 ms
...
`10_breakers/test_empty_script_fetches_nothing.py` — 26 ms
...
`10_breakers/test_fetcher_refuses_off_host_url.py` — 30 ms
...
`10_breakers/test_flat_module_alias.py` — 41 ms

```
flatmod_old.__file__: /tmp/bubble-test-qectuity/vault/flatmod/1.0.0/py3-none-any/flatmod.py
flatmod_new.__file__: /tmp/bubble-test-qectuity/vault/flatmod/2.0.0/py3-none-any/flatmod.py
...
`10_breakers/test_https_index_required.py` — 34 ms
...
`10_breakers/test_importer_refuses_symlinks.py` — 33 ms
...
`10_breakers/test_late_alias_does_not_corrupt_earlier.py` — 51 ms
...
module id stable:  0x7fd2dc5d9b20 → 0x7fd2dc5d9b20
class id stable:   0x318b1ee0 → 0x318b1ee0
STATE dicts distinct: old@0x7fd2dc652580 vs new@0x7fd2dc653700
...
`10_breakers/test_modules_and_deps_indexed.py` — 31 ms
...
`10_breakers/test_recursive_self_host.py` — 423 ms

```
build script: tools/build_pyz.py
bubble run tools/build_pyz.py: rc=0
produced artifact: 84569 bytes
sidecar sha256 matches bytes: e3b41e1aa88e6215…
produced pyz --help responds and lists bubble subcommands
produced pyz `vault list` returned: 'vault is empty'
deterministic: two builds same source → identical sha256 e3b41e1aa88e6215…
```
...
`10_breakers/test_sdist_refused_by_default.py` — 537 ms
...
`10_breakers/test_shell_create_from_manifest.py` — 62 ms
...
`10_breakers/test_top_level_carries_content_hash.py` — 45 ms
...
`10_breakers/test_top_level_contention_logged.py` — 37 ms
...
`10_breakers/test_top_level_index_bridges_import_to_dist.py` — 35 ms

```
distribution name: Carbohydrate-9000
top-level import:  sugar
top_level row:     ('Carbohydrate-9000', '3.0.0', 'sugar')
resolved module:   /tmp/bubble-test-_cku0nqz/vault/Carbohydrate-9000/3.0.0/py3-none-any/sugar/__init__.py
...
`10_breakers/test_top_level_verify_mode.py` — 31 ms
...
`10_breakers/test_two_versions_one_process.py` — 38 ms

```
widget_old.Widget: id=0x23466720
widget_new.Widget: id=0x2346f230
...
```
  bubble-test-i5yl1sap mode=0o700
  vault              mode=0o700
  .staging           mode=0o700
  shells             mode=0o700
  wheels             mode=0o700
...
`30_loop/test_dlmopen_routing_through_proxy.py` — 90 ms
...
staged islet==3.1.4 at /tmp/bubble-test-c5h1pdo5/vault/islet/3.1.4/py3-none-any
...
```
probed_at: 2026-04-27T17:36:26.816634
...
`30_loop/test_subprocess_routing_through_proxy.py` — 105 ms
...
staged islet_sub==3.1.4 at /tmp/bubble-test-im11kofq/vault/islet_sub/3.1.4/py3-none-any
...
`30_loop/test_substrate_routing_learns.py` — 47 ms
